...
const UpdateMaintenanceAmountModal = ({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
			...
			>
				{/* Header */}
				<GradientHeading content={"Update Maintenance Amount"} />
				...
				<input
					...
					className="w-full rounded-md bg-neutral-800 border border-neutral-700 px-3 py-2 text-light placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-yellow-500"
